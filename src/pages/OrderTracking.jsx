...
export default function OrderTracking() {
  ...
  if (!order) return <div className="p-6 text-center text-red-600">Order not found or access denied.</div>;
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white shadow mt-10 rounded">
      ...
      <ul className="space-y-2  text-gray-600 text-sm">
        {order.trackingHistory?.length > 0 ? (
          ...
          <li className="text-gray-500 italic">No tracking updates available yet.</li>
        )}
      </ul>

      {(auth.role === "admin" || auth.role === "farmer") && (
        <div className="mt-6 border-t pt-4">
          <h3 className="font-semibold mb-2">✏️ Update Tracking Status</h3>
