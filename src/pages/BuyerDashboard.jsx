...
export default function BuyerDashboard() {
  ...
  return (
    <div className="p-6 bg-green-50 min-h-screen">
      ...
      {/* 🔍 Filter Inputs */}
      <div className="mb-6 bg-white p-4 rounded shadow flex flex-wrap gap-4 items-center">
        <input
          type="text"
          placeholder="Search product name..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          className="border text-gray-800 px-3 py-2 rounded text-sm w-full sm:w-60"
        />
        ...
        <input
          ...
          className="border text-gray-800 px-3 py-2 rounded text-sm w-24"
        />
        ...
        <button
          className="ml-auto text-sm bg-green-300 text-white hover:underline"
          onClick={() => {
            setSearchTerm("");
            setMinPrice("");
            setMaxPrice("");
